...
//[CreateAssetMenu(fileName = "CastingChasingResources", menuName = "Test/1CastingChasingResources")]
public class CastingChasingStateMachineResources : ScriptableObject
{
    [Header("The objects this casting method needs.")]
    public GameObject CastingChasingPrefab;
    public CastingComponentHolder CastingChasingComponents;
    ...
    [Range(1,20)]
    public float InitialCastingSpeed;

    [Tooltip("How long it takes for the progress circle to catch up to the target.")]
    [Range(1, 30)]
